...
encoded = Dense(encoding_dim * 11, activation='relu')(encoded)
encoded = Dense(encoding_dim * 21, activation='relu')(encoded)
encoded = Dense(encoding_dim * 30, activation='relu')(encoded)
encoded = Dense(encoding_dim * 45, activation='relu')(encoded)
encoded = Dense(encoding_dim * 57, activation='relu')(encoded)
encoded = Dense(encoding_dim * 62, activation='relu')(encoded)
