...
from sklearn.ensemble import GradientBoostingClassifier         # RandomForest -> XG_boost(pip install XG_boost) -> keras
...
def create_hyperparameters():
    ...
    return {"learning_rate":learning_rate, "n_estimators":n_estimators, "max_depth":max_depth, 
            ...
            "min_child_weight":min_child_weight, "base_score":base_score}      # Map 형태로 반환
...
"""
best_parameters :  {'n_jobs': -1, 'n_estimators': 500, 'min_samples_leaf': 100, 'min_child_weight': 1, 'max_leaf_nodes': 2000, 'max_depth': 1000, 'learning_rate': 0.2}
best_estimator :  XGBClassifier(base_score=0.5, booster='gbtree', colsample_bylevel=1,
       ...
       max_delta_step=0, max_depth=1000, max_leaf_nodes=2000,
       min_child_weight=1, min_samples_leaf=100, missing=None,
       n_estimators=500, n_jobs=-1, nthread=None,
       objective='multi:softprob', random_state=0, reg_alpha=0,
       reg_lambda=1, scale_pos_weight=1, seed=None, silent=None,
       subsample=1, verbosity=1)
best_score(x_train) :  0.9433384379785605
test_score : 0.9336734693877551
PS D:\study>
"""
