...
################# 모델 구성 ####################
from keras.layers import Input, Dense, BatchNormalization, Dropout, Conv2DTranspose, Conv2D, MaxPooling2D, UpSampling2D
...
x = Conv2D(18, (5, 5), activation='relu', padding='same')(x)
x = Conv2D(24, (6, 6), activation='relu', padding='same')(x)
x = MaxPooling2D((4, 4), padding='same')(x)
x = BatchNormalization()(x)
encoded = Conv2D(18, (2, 2), activation='relu', padding='same')(x)
...
x = Conv2D(20, (4, 4), activation='relu', padding='same')(x)
